...
import { normalizeCodexWithComponent } from "./identity.mjs";

// Lifecycle policy is component-owned. This module only joins Codex's
// envelope to the typed component records.
export function planCodexLifecycleWithComponent(payload, engine, binding = undefined) {
  const identity = normalizeCodexWithComponent(resumePayload(payload, binding), engine);
...
export function assertCodexLifecycleSucceeded(operation, response) {
