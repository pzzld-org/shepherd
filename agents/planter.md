...
model: opus[1m]
tools: [Read, NotebookRead, Glob, Grep, Bash, Write, Edit, Skill, ToolSearch, Agent, Workflow, AskUserQuestion, TaskCreate, TaskGet, TaskList, TaskUpdate, WebFetch, WebSearch]
dispatchable: false
write_eligible: true
