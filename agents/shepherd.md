...
model: inherit
tools: [Read, NotebookRead, Glob, Grep, Bash, Write, Edit, Skill, ToolSearch, Agent, Workflow, SendMessage, TaskCreate, TaskGet, TaskList, TaskUpdate, WebFetch, WebSearch]
dispatchable: false
write_eligible: true
