...
3. **Lane-plan PATH present and readable** — the brief carries `lane_plan: {run_dir}/lanes/{lane}/plan.md` (a PATH, never a pasted brief slice) and the file exists with steps + acceptance. Path absent or file unreadable → `TEAMMATE-BOOT-MALFORMED`.
