...
# The hook resolves only the installed native CLI. A source-tree test supplies
# the freshly-built test binary through PATH, never a plugin-local launcher.
