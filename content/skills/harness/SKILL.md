...
implementation, never here — Codex's `spawn_agent` + lifecycle hooks + a hard 3-descendant
concurrency cap, and Pi's session-per-role subprocess model with a strict-replacing
