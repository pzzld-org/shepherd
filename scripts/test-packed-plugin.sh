...
test -f "$tarballs/pzzld-component-runtime-6.4.8.tgz"
test -f "$tarballs/pzzld-pi-claude-6.4.8.tgz"
test -f "$tarballs/pzzld-pi-codex-6.4.8.tgz"
test -f "$tarballs/pzzld-pi-shepherd-6.4.8.tgz"
component_listing="$tmp_dir/component-runtime.list"
tar -tzf "$tarballs/pzzld-component-runtime-6.4.8.tgz" > "$component_listing"
...
for package in component-runtime harness-claude harness-codex harness-pi; do
  ...
  tar -tzf "$tarballs/${archive}-6.4.8.tgz" > "$listing"
...
npm_config_cache="$tmp_dir/npm-cache" \
  ...
  "$tarballs/pzzld-component-runtime-6.4.8.tgz" \
  "$tarballs/pzzld-pi-claude-6.4.8.tgz" \
  "$tarballs/pzzld-pi-codex-6.4.8.tgz" \
  "$tarballs/pzzld-pi-shepherd-6.4.8.tgz" >/dev/null
