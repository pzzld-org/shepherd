...
test -f "$tarballs/pzzld-component-runtime-6.5.5.tgz"
test -f "$tarballs/pzzld-claude-shepherd-6.5.5.tgz"
test -f "$tarballs/pzzld-codex-shepherd-6.5.5.tgz"
test -f "$tarballs/pzzld-pi-shepherd-6.5.5.tgz"
component_listing="$tmp_dir/component-runtime.list"
tar -tzf "$tarballs/pzzld-component-runtime-6.5.5.tgz" > "$component_listing"
...
for package in component-runtime harness-claude harness-codex harness-pi; do
  ...
  tar -tzf "$tarballs/${archive}-6.5.5.tgz" > "$listing"
...
npm_config_cache="$tmp_dir/npm-cache" \
  ...
  "$tarballs/pzzld-component-runtime-6.5.5.tgz" \
  "$tarballs/pzzld-claude-shepherd-6.5.5.tgz" \
  "$tarballs/pzzld-codex-shepherd-6.5.5.tgz" \
  "$tarballs/pzzld-pi-shepherd-6.5.5.tgz" >/dev/null
