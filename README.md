...
Semver: **major** = closed-flock contract change; **minor** = new commands/config keys; **patch** = dispatch/brief-template fixes. Current version: **6.5.0**. See [`CHANGELOG.md`](CHANGELOG.md).
